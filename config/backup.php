...
return [
    ...
    'backup' => [
        ...
        'name' => Str::slug(env('APP_NAME', 'laravel') . '-backups'),
        ...
        'source' => [
            ...
            'files' => [
                ...
                'include' => [
                    ...
                    // Since we're using Envoyer which will symlink some files and
                    // directories, we have to explicitly include them in the backup.
        ...
        'destination' => [
            ...
            'filename_prefix' => Str::slug(env('APP_NAME', 'laravel') . '-backups') . '-',
